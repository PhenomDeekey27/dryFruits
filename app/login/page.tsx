  ...
  return (
    <div className="min-h-screen bg-[#fcf9f8] flex items-center justify-center p-4">
      ...
      <main className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 rounded-2xl overflow-hidden bg-white shadow-2xl shadow-[#1b1c1c]/5">
        ...
        <section className="hidden md:block relative min-h-[680px] overflow-hidden">
          ...
          <div className="absolute bottom-12 left-10 right-10 text-[#fcf9f8]">
            ...
            <p className="text-[15px] text-[#fcf9f8]/85 leading-relaxed max-w-sm">
              Sourcing the world's most exceptional dry fruits and dates, delivered with editorial care to your table.
            </p>
          </div>
        </section>
        ...
        <section className="flex flex-col justify-center px-8 md:px-14 py-12 bg-[#fcf9f8]">
          ...
          <div className="max-w-sm w-full mx-auto">
            <div className="mb-8">
              ...
              <p className="text-[14px] text-[#504441]">Sign in to access your curated collection.</p>
            </div>

            <LoginForm />

            <p className="text-center text-[13px] text-[#504441] mt-8">
              Don&apos;t have an account?{' '}
              <Link href="/signup" className="text-[#775a19] font-bold hover:underline transition-colors">
                Create Account
              </Link>
            </p>
