        ...
        <section className="flex flex-col justify-center px-8 md:px-14 py-12 bg-[#fcf9f8]">
          ...
          <div className="max-w-sm w-full mx-auto">
            <div className="mb-8">
              ...
              <p className="text-[14px] text-[#504441]">Start your journey with premium dry fruits.</p>
            </div>

            <SignupForm />

            <p className="text-center text-[13px] text-[#504441] mt-6">
            ...
            <p className="text-center text-[10px] uppercase tracking-[0.18em] text-[#504441]/40 font-semibold mt-8">
