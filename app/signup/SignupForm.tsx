...
export default function SignupForm() {
  const [state, formAction, pending] = useActionState(signup, { error: '', success: '' })
  ...
  return (
    <div className="space-y-5">
      ...
      {state.success?.length > 0 && (
        <div className="bg-[#dcfce7] text-[#166534] text-[12.5px] px-4 py-3 rounded-xl space-y-1">
          <p className="font-semibold">Check your email!</p>
          <p>{state.success}</p>
          <p className="mt-2">
            <Link href="/login" className="underline font-semibold">Back to sign in</Link>
          </p>
        </div>
      )}
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-[11px] uppercase tracking-widest">
          <span className="bg-[#fcf9f8] px-4 text-[#504441]/60 font-semibold">Or register with email</span>
        </div>
      </div>
